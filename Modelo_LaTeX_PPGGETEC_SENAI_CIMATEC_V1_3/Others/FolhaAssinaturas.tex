...
\def\signaturepage{%
   ...
   \vskip 0.25in plus 0.4in minus 0.1in
    ...
    \begin{spacing}{1.5}
        ...
        listados, leram e recomendam a aprova\c{c}\~ao da
   ...
   % \InstituicaoMembro{}{Instituição do membro da banca} \\

\begin{center}
 (Substituir pela folha de assinaturas oficial para a impressão final)   
\end{center}
