...
\usepackage[alf,abnt-etal-cite=2,abnt-etal-list=2,abnt-and-type=&]{abntex2cite}
\usepackage{ifpdf}
\usepackage{shadow}
\usepackage{wrapfig}
...
\begin{document}
    ...
    \thesistitle{Desenvolvimento de sensores eletromec\^anicos por tecnologia de deposição thick
film visando aplicações em sistemas robóticos cirúrgicos baseados em soft robotics}
    \hidevolume
    \thesisvolume{Volume 1 of 1}
    \thesisauthor{Juca Maria Nascimento Ribeiro}
    \thesisadvisor{Prof(a). Dr(a). Rodrigo Santiago Coelho}
    %\hidecoadvisor
    \thesiscoadvisor{Prof(a). Ms(a). Jonathan Costa Negri}
    \universitycoadv{IES}
